                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Request For Leads</h5>
                       
                        </div>
                        <div class="ibox-content">
                                 <form class="form-horizontal" action="<?php echo base_url() ?>admin/insert_request" method="post" name="tech_form" enctype="multipart/form-data">
                        ...
                        <h4><strong>Client Details</strong></h4>
                                ...
                                <div class="panel-footer">
                                       ...
                                       <input type="submit" name="submit2" value="Submit Lead" class="btn btn-danger pull-right btn_submit"    />
                                </div>
                            </div>
                            </form>
