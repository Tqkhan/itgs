...
<body style="background-image: url(<?php echo base_url()?>admin_assets/img/bg-wallpaper.jpg); background-size: cover;">
<!-- class ADD loginscreen -->
	<div class="middle-box text-center  animated fadeInDown" style="border-top: 5px solid #c62026;background: rgba(255, 255, 255, 0.81);box-shadow: 0 0 10px 0px; width: 358px; height: auto; border-radius: 3px; position: fixed;">

		<div style="margin-top: -55px;">

				<!-- <h1 class="logo-name"><img src="<?php echo base_url() ?>assets/logo.png"></h1> -->
			<h1 class="logo-name"><img src="<?php echo base_url()?>admin_assets/img/logo.png" height="67" width="268"></h1>
...
<script type="text/javascript">
  ...
  var action = $(this).val();
    ...
    if (action=='admin') {
    	  $("#search-form").attr("action", "<?php echo base_url() ?>admin/do_admin_login");
    }
    else if (action=='employee') {
    	  $("#search-form").attr("action", "<?php echo base_url() ?>admin/employee_login");
    }
    else if (action=='client') {
    	  $("#search-form").attr("action", "<?php echo base_url() ?>admin/client_login");
    }   
});
</script>
</html>
