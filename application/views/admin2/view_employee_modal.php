                                        ...
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                           ...
                                           <?php foreach ($employees as $employee): ?>
                                             <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url() ?>admin/admin_edit/<?php echo $employee['id'] ?>"><img src="<?php echo base_url('admin_assets/img/edit.png') ?>" title="Edit Employee" alt="Edit Employee" width="25" height="25"></a>
                                                    <a href="<?php echo base_url() ?>admin/emp_delete/<?php echo $employee['id'] ?>"><img src="<?php echo base_url('admin_assets/img/f.png') ?>" title="Delete Employee" alt="Delete Employee" width="25" height="25"></a>
                                                </td>
