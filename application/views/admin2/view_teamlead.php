									...
									<div class="table-responsive">
										...
										<table id="dataTableExample2" class="table table-bordered table-striped table-hover">
											...
											<tbody>
												...
												<?php foreach ($team_lead as $team): ?>
													<tr>
													<td><?php echo $team['employee_name'] ?></td>
													<td><?php echo $team['employee_id'] ?></td>
													<td><?php echo $team['designation'] ?></td>
													<td><?php echo $team['department'] ?></td>
													<td><a href="<?php echo base_url() ?>admin/assign_case_to_tl?team_lead=<?php echo $team['id'] ?>" class="btn btn-success" >
														Assign Case
														</a>
														<br>
														<a href="<?php echo base_url() ?>admin/view_assigned_case?team_lead=<?php echo $team['id'] ?>" class="btn btn-info" >
														View Assigned Cases
														</a>
													</td>
												</tr>
