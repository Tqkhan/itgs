<?php include "all_scripts.php" ?>
            ...
            <div id="page-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="panel-body">
                                    <form method="post" action="<?php echo base_url()?>admin/create_meeting" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <label for="example-text-input" class="col-sm-4 col-form-label">Title<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" name="title" id="example-text-input" placeholder="" required="">
            </div>
        ...
        <div class="form-group row">
           ...
           <div class="col-sm-8">
                <input class="form-control" type="time" value="meeting_time" name="meeting_time" id="example-text-input" placeholder="" required="">
            </div>
        ...
        <div class="form-group row">
          ...
          <label for="example-text-input" class="col-sm-4 col-form-label">Notes<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" value="" name="notes" id="example-text-input" placeholder="">
            </div>
        ...
        <div class="form-group row">
           ...
           <div class="col-sm-8">
                 <select data-placeholder="Choose Category..." class="form-control" multiple tabindex="3" id="example-text-input" style="background: #555; color: white;" name="userID[]" required="">
                              ...
                              <?php foreach ($users as $user): ?>
                                    <option value="<?php echo $user['login_id'] ?>"><?php echo $user['login_name'] ?></option>
                                <?php endforeach ?> 
                 </select>
            </div>
         ...
         <div class="form-group row">
          <label for="example-text-input" class="col-sm-4 col-form-label">Search Location<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" value="" name="tag_other_employee" id="us3-address" placeholder="">
            </div>
        </div>
        <div class="form-group row">
