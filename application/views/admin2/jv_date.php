					...
					<div class="content-header">
						...
						<div class="header-title">
							...
							<ol class="breadcrumb">
								...
								<li class="active">Date Wise JV</li>
...
<div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="panel-body panel-bd panel">
                                ...
                                <form action="<?php echo base_url()?>admin/jv_date" method="post">
		    ...
		    <table id="dataTableExamplejv_date" class="table table-bordered table-striped table-hover">
...
foreach ($lists as $list): 
	...
	<td><span class="footable-toggle"></span><?php echo $list['created_at'] ?></td>

	<td><span class="footable-toggle"></span>Journal Voucher</td>

	<td><span class="footable-toggle"></span><?php echo $list['charges'] ?></td>
