...
<!-- main content -->
    <div class="content">
        ...
        <form  id="example-form" method="post" action="<?php echo base_url() ?>admin/client_update" enctype="multipart/form-data">
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="client_name" value="<?php echo $client['client_name'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-3 col-form-label">Username<span class="required">*</span></label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="login_name" value="<?php echo $client['login_name'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-3 col-form-label">Password<span class="required">*</span></label>
                        <div class="col-sm-9">
                            <input class="form-control" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="password field should contain first letter Capital with some special characters or numbers i.e. (ExamplE@123)" name="password" value="<?php echo $client['password'] ?>" id="test1" placeholder="" required=""><input id="test2" type="checkbox" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="abbreviation" value="<?php echo $client['abbreviation'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-3 col-form-label">Address<span class="required">*</span></label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="address" value="<?php echo $client['address'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="country_id" id="" class="form-control" required="">
                              ...
                              <?php foreach ($countries as $country): ?>
                                <option value="<?php echo $country['id'] ?>-<?php echo $country['country_code'] ?>" <?php if($client['country_id'] == $country['id']) echo 'selected' ?>><?php echo $country['country_name'] ?>- <?php echo $country['country_code'] ?></option>
                              <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="client_contact" value="<?php echo $client['client_contact'] ?>" id="phone-number" maxlength="20" placeholder="" required="">
                        </div>
...
$.toggleShowPassword({
    ...
    control: '#test2'
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="email" name="email" value="<?php echo $client['email'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                    <?php 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="website" value="<?php echo $client['website'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select name="employee_id" id="" class="form-control" required="">
                              ...
                              <?php foreach ($employees as $employee): ?>
                                <option value="<?php echo $employee['id'] ?>" <?php if($employee['id'] == $client['employee_id']) echo 'selected' ?>><?php echo $employee['employee_name'] ?></option>
                              <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="reg_num" value="<?php echo $client['reg_num'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                        <label for="example-text-input" class="col-sm-2 col-form-label">Tax No<span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input class="form-control" type="text" name="tax_num" value="<?php echo $client['tax_num'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 checkbox checkbox-primary s">
                          <?php
                            $scount=1;
                            $serve = explode(',', $client['service_id']);
                        ...
                        <div class="col-sm-3">
                            <label class="rad inline">
                                  <input type="radio" name="client_type" value="INT" <?php if('INT' == $client['client_type']) echo 'checked' ?>>
                                  <span> International </span>
                               </label>
                              <label class="rad inline margen">
                                  <input type="radio" name="client_type" value="LC" <?php if('LC' == $client['client_type']) echo 'checked' ?>>
                                  <span> Local </span>
                              </label>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="contract_start_date" value="<?php echo $client['contract_start_date'] ?>" id="txtFromDate" placeholder="" required="">
                        </div>
                        <label for="example-text-input" class="col-sm-2 col-form-label">Contract End Date<span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input class="form-control" type="text" name="contract_end_date" value="<?php echo $client['contract_end_date'] ?>" id="txtToDate" placeholder="" required="">
                        </div>
                    </div>
                    <script type="text/javascript">
        ...
        onSelect: function(selected) {
           $("#txtFromDate").datepicker("option","maxDate", selected)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="date" min="<?php echo date('Y-m-d',strtotime($client['reg_date']))?>" name="reg_date" value="<?php echo $client['reg_date'] ?>" id="example-text-input" placeholder="" required="">
                        </div>
                        <label for="example-text-input" class="col-sm-2 col-form-label">Status<span class="required">*</span></label>
                        <div class="col-sm-4">
                            <label class="rad inline">
                                  <input type="radio" name="status" value="1" <?php if('1' == $client['status']) echo 'checked' ?>>
                                  <span> Active </span>
                               </label>
                              <label class="rad inline margen">
                                  <input type="radio" name="status" value="0" <?php if('0' == $client['status']) echo 'checked' ?>>
                                  <span> Blocked </span>
                              </label>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <label class="rad inline">
                                  <input type="radio" name="sub_account" value="1" <?php if('1' == $client['sub_account']) echo 'checked' ?> >
                                  <span> Yes </span>
                               </label>
                              <label class="rad inline margen">
                                  <input type="radio" name="sub_account" value="0" <?php if('0' == $client['sub_account']) echo 'checked' ?>>
                                  <span> No </span>
                              </label>
                              <label class="rad inline margen">
                                  <input type="radio" name="is_parent" value="1" <?php if('1' == $client['is_parent']) echo 'checked' ?> >
                              </label>
                              <label class="rad inline margen">
                                  <input type="radio" name="is_parent" value="0" <?php if('0' == $client['is_parent']) echo 'checked' ?> >
                              </label>
                        </div>
                        <br><br><br>
                        <hr>
