...
<div id="page-wrapper">
   ...
   <div class="content">
      ...
      <!-- /. Content Header (Page header) -->
      <form method="post" action="<?php echo base_url() ?>/admin/insert_memo" enctype="multipart/form-data">
         <div class="row">
            <div class="col-sm-12">
                  ...
                  <div class="panel-body">
                   <div class="form-group col-lg-6">
                        ...
                        <select class="form-control req" required="" id="department" name="department">
                            <option value="">Select Department</option>    <option value="all">All</option>
 ...
 -->
                   ...
                   <div class="form-group col-lg-12">
                     ...
                     <div class="col-lg-6" id="profile-container">
                        <input id="file" type="file" name="file" placeholder="Photo" capture>
                    </div>
