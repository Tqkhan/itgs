                            ...
                            <div class="panel panel-bd">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                       <?php 
                                                            ...
                                                            elseif (isset($cv['interview'][0]) && $cv['interview']['con'] == 0) {
                                                    ...
                                                    <td>
                                                        ...
                                                        <a style="margin-right: 5px;" href="<?php echo base_url() ?>/admin/recruitment_score/<?php echo $cv['id'] ?>"><img src="<?php echo base_url('admin_assets/img/view_report.png') ?>" width="25" heigth="25" title="View Scope Card"></a>
                                                    <a href="<?php echo base_url() ?>admin/delete_recruitment/<?php echo $cv['id'] ?>"><img src="<?php echo base_url() ?>assets/d-icon.png" title="Delete" alt="Delete" width="25" height="25"></a>
                                                    <?php 
                                                        if ($cv['latter'] == 0) {
                                                    ?>
                                                    <a href="" class="get_id" data-toggle="modal" data-id="<?php echo $cv['id'] ?>" data-target="#myModal" onclick="client_chat( 195)"><img src="<?php echo base_url('admin_assets/img/schedule.png') ?>" width="25" heigth="25" title="Interview Schedule"></a>
                                                    <?php } ?>
                                                </td>
                                                </tr>
                                            <?php    
                                        ...
                                        <a href="<?php echo base_url() ?>admin/interview_step_1"><button type="" class="btn btn-primary pull-right">Interview Manager</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                   <form method="POST" action="<?php echo base_url()?>admin/add_interview" enctype="multipart/form-data">
...
</div><div style="height:237px;"></div>
        </div><!-- /#wrapper -->
        <!-- START CORE PLUGINS -->
