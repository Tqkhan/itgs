                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Create Empolyee</li>
                                </ol>
                            </div>
    ...
    <div class="panel panel-default panel panel-bd">
      ...
      <div id="collapse1" class="panel-collapse collapse ">
        ...
        <div class="form-group row">
            ...
            <label for="example-text-input" class="col-sm-2 col-form-label">Last Name<span class="required">*</span></label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            ...
            <label for="example-text-input" class="col-sm-2 col-form-label">CNIC<span class="required">*</span></label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Image<span class="required">*</span></label>
            <div class="col-sm-4">
    ...
    <div class="form-group row">
            ...
            <label for="example-text-input" class="col-sm-2 col-form-label">Cell Number<span class="required">*</span></label>
            <div class="col-sm-4">
    ...
    <div class="form-group row">
            ...
            <label for="example-text-input" class="col-sm-2 col-form-label">Residence Address<span class="required">*</span></label>
            <div class="col-sm-4">
    ...
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Permanent Address<span class="required">*</span></label>
            <div class="col-sm-4">
 ...
 <hr>
    ...
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Employee Code<span class="required">*</span></label>
            <div class="col-sm-4">
    ...
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Password<span class="required">*</span></label>
            <div class="col-sm-4">
...
<option value="92">AM Dispatch</option>
    ...
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Grade<span class="required">*</span></label>
            <div class="col-sm-4">
    ...
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Department<span class="required">*</span></label>
            <div class="col-sm-4">
...
<option value="52"> PMC</option>
    ...
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Is Admin<span class="required">*</span></label>
            <div class="col-sm-4">
             ...
             <label for="example-text-input" class="col-sm-2 col-form-label">Basic<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="basic" placeholder="">
            </div>
    </div>
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">HR<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="hr" placeholder="">
            </div>
             <label for="example-text-input" class="col-sm-2 col-form-label">Utilities<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="utilities" placeholder="">
            </div>
    </div>
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Medical<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="medical" placeholder="">
            </div>
             <label for="example-text-input" class="col-sm-2 col-form-label">Conveyance<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="conveyance" placeholder="">
            </div>
    </div>
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Cash Gross (Comp 3)<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="cash_gross" placeholder="">
            </div>
             <label for="example-text-input" class="col-sm-2 col-form-label">PF<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="pf" placeholder="">
            </div>
    </div>
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Bonus<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="bonus" placeholder="">
            </div>
             <label for="example-text-input" class="col-sm-2 col-form-label">EL<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="number" value="" id="example-text-input" name="el" placeholder="">
            </div>
    </div>
    <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Total Gross (Comp 5)<span class="required">*</span></label>
            <div class="col-sm-4">
    ...
    <div class="panel panel-default panel panel-bd">
      ...
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body ">
          <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Add Job Description<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="text" value="" id="example-text-input" name="add_job_description" placeholder="">
            </div>
             <!-- <label for="example-text-input" class="col-sm-2 col-form-label">Fetch job Description<span class="required">*</span></label>
                         <div class="col-sm-4">
     ...
     <div class="panel panel-default panel panel-bd">
      ...
      <div id="collapse4" class="panel-collapse collapse in">
            ...
            <div class="form-group row">
            <div class="col-sm-12">
                <a class="btn btn-success  pull-right">Fetch Job</a>
            </div>
        ...
        <div class=" after-add-kpi">
          ...
          <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Add Job KPI<span class="required">*</span></label>
            <div class="col-sm-4">
                <input class="form-control" type="text" value="" id="example-text-input" name="add_job_kpi[]" placeholder="">
            </div>
             <label for="example-text-input" class="col-sm-2 col-form-label">Assign Weightage<span class="required">*</span></label>
            <div class="col-sm-4">
