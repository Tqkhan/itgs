                ...
                $('#calendar').fullCalendar({
                    ...
                    events: [
                        ...
                        ?>
                        {
                            ...
                            title: '<?php echo $record['title'] ?> (Birthday)',
                            start: '<?php echo date('Y').'-'.date('m-d',strtotime($record['dob'])) ?>',
                            url: "#",
                           // end: '<?php echo $record['end_date'] ?>'
                        },
                        <?php } ?>
                        <?php 
                            foreach ($secound as $record) {
                        ?>
                        {
                            id: 'event-<?php echo $record['id'] ?>',
                            title: '<?php echo $record['title'] ?> (Anniversary)',
                            start: '<?php echo date('Y').'-'.date('m-d',strtotime($record['dob'])) ?>',
                            url: "#",
