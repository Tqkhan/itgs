...
$data=[];
$data[] = "[{v:'Ceo', f:'<b>Ceo</b><br/><a class=\"designation\" href=\"#\">View detail</a>'}, '', '']";
foreach ($employees as $d) {
	if ($d['report_to'] == 0) {
		$data[] = "[{v:'".$d['id']."', f:'<b>".$d['employee_name'] . "</b><br/><a class=\"designation\" href=\"".base_url('admin/emp_org/'.$d['id'])."\">View detail</a>'}, 'Ceo', '']";
	}
	else{
		$data[] = "[{v:'".$d['id']."', f:'<b>".$d['employee_name'] . "</b><br/><a class=\"designation\" href=\"".base_url('admin/emp_org/'.$d['id'])."\">View detail</a>'}, '".$d['report_to']."', '']";
	}
}
                ...
                <div class="panel panel-bd ">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <a href="<?php echo base_url('admin/view_employee') ?>"><button class="btn btn-primary pull-right">Create</button></a>
                        </div>
                    </div>
