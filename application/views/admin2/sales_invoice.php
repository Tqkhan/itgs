...
<?php 
$tax = ($c['client_type']!="INT") ? $activity_price['activity_price']*13/100 : 0
...
<!--   <td><?php echo $activity_price['activity_price']*13/100; 
  ...
  <td><?php echo  $activity_price['activity_price'] +$tax; 

  $activity_pricetax_total+=$activity_price['activity_price'] +$tax; 
  ...
  <td><?php echo ($c['client_type']!="INT") ? $activity_price['activity_price']*13/100 : 0; 

          $activity_tax_total+=($c['client_type']!="INT") ? $activity_price['activity_price']*13/100 : 0;
