							...
							<div class="panel panel-bd">
								<div class="panel-heading">
									<div class="panel-title">
										<h4>Monthly Assessment Bills</h4>
									</div>
								</div>
...
?>
				<tr>
                    ...
                    if ($case['case_date'] != null && $case['case_date'] != '') {
                        $old_date = $case['case_date'];              // returns Saturday, January 30 10 02:06:34
                    ...
                    ?>
                    <td><span class="footable-toggle"></span><?php echo $new_date ?></td>
                    <td><span class="footable-toggle"></span><?php echo $case['reference_code'] ?></td>
                     ...
                     <td><span class="footable-toggle"></span><?php echo $case['vendor_changes'] ?></td>
                     <td><span class="footable-toggle"></span><?php echo $case['other_charges'] ?></td>
                     <td><span class="footable-toggle"></span><?php echo $total; ?></td>
                    <?php
                    if ($case['hold_date'] != null && $case['hold_date'] != '') {
                        $old_date = $case['hold_date'];              // returns Saturday, January 30 10 02:06:34
                        $old_date_timestamp = strtotime($old_date);
                    ...
                    ?>
                   <!--  <td><span class="footable-toggle"></span><?php echo $new_date1 ?></td> -->
                    <?php
                    if ($case['unhold_date'] != null && $case['unhold_date'] != '') {
                        $old_date = $case['unhold_date'];              // returns Saturday, January 30 10 02:06:34
                        $old_date_timestamp = strtotime($old_date);
                    ...
                    ?>
                    <!-- <td><span class="footable-toggle"></span><?php echo $new_date2 ?></td> -->
