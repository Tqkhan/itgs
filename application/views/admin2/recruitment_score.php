...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <?php
            if (!empty($call_interview) || !empty($per_interview)) {
        ?>
        <div class="row">
            <div class="col-sm-12 lobipanel-parent-sortable ">
                <div class="panel panel-bd ">
                        ...
                        <div class="table-responsive">
                            <div id="dataTableExample1_wrapper">
                                <table id="" class="table table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="dataTableExample1_info">
                                    <thead>
                                        <tr role="row">
                                            <th style="width: 139px;">S.no</th>
                                            <th style="width: 139px;">Interview Type</th>
                                            <th style="width: 139px;">Interviewer</th>
                                            <th style="width: 139px;">Date</th>
                                            <th style="width: 139px;">Point</th>
                                            <th style="width: 139px;">Recommended</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr role="row" class="odd">
                                            <?php $point= $point + $call['point']; ?>
                                            <td style="width: 139px;"><?php echo $con+1 ?></td>
                                            <td style="width: 139px;">Call Interview</td>
                                            <td style="width: 139px;"><?php echo $call['employee_name'] ?></td>
                                            <td style="width: 139px;"><?php echo $call['date'] ?></td>
                                            <td style="width: 139px;"><?php echo $call['point'] ?></td>
                                            <?php 
                                                if ($call['recommended'] == '0') {
                                                    $rec = 'Approve';
                                                }
                                                elseif ($call['recommended'] == '1') {
                                                    $rec = 'Reject';
                                                }
                                                elseif ($call['recommended'] == '2') {
                                                    $rec = 'Next Interview';
                                                }
                                            ?>
                                            <td style="width: 139px;"><?php echo $rec ?></td>
                                        </tr>
                                        <?php 
                                            $con++;
                                            }
                                        ...
                                        ?>
                                        <tr role="row" class="odd">
                                            <?php $point= $point + $pre['point']; ?>
                                            <td style="width: 139px;"><?php echo $con+1 ?></td>
                                            <td style="width: 139px;">Person Interview</td>
                                            <td style="width: 139px;"><?php echo $pre['employee_name'] ?></td>
                                            <td style="width: 139px;"><?php echo $pre['date'] ?></td>
                                            <td style="width: 139px;"><?php echo $pre['point'] ?></td>
                                            <?php 
                                                if ($pre['recommended'] == '0') {
                                                    $rec = 'Approve';
                                                }
                                                elseif ($pre['recommended'] == '1') {
                                                    $rec = 'Reject';
                                                }
                                                elseif ($pre['recommended'] == '2') {
                                                    $rec = 'Next Interview';
                                                }
                                            ?>
                                            <td style="width: 139px;"><?php echo $rec ?></td>
                                        ...
                                        ?>
                                        <tr>
                                            <td style="width: 139px;">Total</td>
                                            <td style="width: 139px;"></td>
                                            <td style="width: 139px;"></td>
                                            <td style="width: 139px;"></td>
                                            <td style="width: 139px;"><?php echo $point / $con; ?> / 10</td>
                                            <td style="width: 139px;"></td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <?php } ?>
        <?php 
            if ($recruitment[0]['latter'] == 0) {
        ?>
        <div class="row">
            <div class="col-sm-12">
                <a href="<?php echo base_url() ?>admin/reject_recruitment/<?php echo $id ?>"><button style="margin-left: 10px" type="" class="btn btn-danger pull-right">Reject</button></a>
                <a href="<?php echo base_url() ?>admin/latter_recruitment/<?php echo $id ?>"><button type="" class="btn btn-primary pull-right">Create Offer Latter</button></a>
            </div>
        </div>
        <?php } ?>
    </div>
