...
<script type="text/javascript" src="https://www.phpflow.com/demo/tableExport-jquery-plugin-demo/jspdf/libs/base64.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>admin_assets\dist\js\bootstrap-select.js"></script>
        ...
        <script src="<?php echo base_url() ?>admin_assets/assets/dist/js/jQuery.style.switcher.min.js" type="text/javascript"></script>
          <script src="<?php echo base_url() ?>admin_assets/assets/plugins/bootstrap-wizard/jquery.backstretch.min.js" type="text/javascript"></script>
                  <script src="<?php echo base_url() ?>admin_assets/assets/plugins/bootstrap-wizard/form.scripts.js?v=1" type="text/javascript"></script>
    ...
    function(){
        ...
        <?php
         ...
         foreach ($months as $month) {
            $response_process[]=$this->db->get_where('lead',['month'=>$month,'status'=>'process'])->num_rows();
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: "Completed",
                                data: <?= json_encode($response_completed); ?>,
...
<?php
           $count_process=$this->db->get_where('lead',['status'=>'process'])->num_rows();
            $count_pending=$this->db->get_where('lead',['status'=>'pending'])->num_rows();
            $count_completed=$this->db->get_where('lead',['status'=>'completed'])->num_rows();
?>
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        datasets: [{
                                data: [<?= $count_pending ?>,<?= $count_process ?>,<?= $count_completed ?>],
                                backgroundColor: [
                                    "rgba(0,0,0,.07)",
                                    "rgba(0,0,0,.15)",
                                    "rgba(85, 139, 47, 0.7)"
        ...
        <script type="text/javascript">
            var chk1 = $("input[type='radio'][value='1']");
            var chk2 = $("input[type='radio'][value='1']");
