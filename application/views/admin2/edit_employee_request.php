                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel-body">
                                ...
                                <form method="post" action="<?php echo base_url() ?>admin/edit_employee_admin">
                                    <input type="hidden" name="id" value="<?php echo $employee['id'] ?>">
                                    <div class="form-group row">
                                        <div class="form-group col-lg-6">
                                        <label for="">Employee ID</label>
                                        <input type="text" class="form-control" id="" value="<?php echo $employee['employee_id'] ?>"  placeholder="" required name="employee_id">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="">Name</label>
                                            <input type="text" class="form-control" value="<?php echo $employee['employee_name'] ?>" name="employee_name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-lg-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="">Email Address</label>
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="login_name" value="<?php echo $employee['login_name'] ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" id="test1" value="<?php echo $employee['password'] ?>" class="form-control" name="password" required><input id="test2" type="checkbox" /><small id="emailHelp" class="text-muted">Show password</small>
                                            </div>
                                        </div>
                                    </div>
