                            ...
                            <div class="panel panel-bd">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="dataTableExampleleave_application_finance" class="table table-bordered table-striped table-hover">
                                            <thead>
                                                <tr>
                                           ...
                                           <tbody>
                                            ...
                                            ?>
                                              <tr>
                                                ...
                                                ?>
                                                <td>
                                                    <a href="<?php echo base_url() ?>admin/leave_application_approve_finance/<?php echo $list['id'] ?>"><button type="" class="btn btn-primary">Approve</button></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url() ?>admin/leave_application_reject_finance/<?php echo $list['id'] ?>"><button type="" class="btn btn-danger">Reject</button></a></td>
                                                <?php }else{ ?>
