...
<div class="row">
                        <div class="col-sm-12">
                            <div class="panel-body panel-bd panel">
                                <form action="<?php echo base_url()?>admin/cash_date" method="post">
		    ...
		    <table id="dataTableExamplecash_date" class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					<th>S.no</th>
					<th>Date</th>
...
foreach ($lists as $list): 
	...
	<td><span class="footable-toggle"></span><?php echo $list['date_time'] ?></td>
