                                        ...
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                           ...
                                           <?php foreach ($employees as $employee): ?>
                                             <tr>
                                                ...
                                                <td><a href="<?php echo base_url() ?>admin/admin_creation/<?php echo $employee['id'] ?>"><img src="<?php echo base_url('admin_assets/img/article-icon.png') ?>" title="Create Employee" alt="Create Employee" width="25" height="25"></a></td>
