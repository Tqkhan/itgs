                                        ...
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                           ...
                                           <?php foreach ($clients as $client): ?>
                                             <tr>
                                                ...
                                                <td><a href="<?php echo base_url() ?>admin/edit_sub_client/<?php echo $client['client_id'] ?>"><img src="<?php echo base_url('admin_assets/img/edit.png') ?>" title="Edit Report" alt="Edit Report" width="25" height="25"></a></td>
