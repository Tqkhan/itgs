...
<!-- main content -->
  ...
  <?php if ($subject['team_lead_id'] == $_SESSION['id']) {?>
   <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-bd ">
                                <div class="panel-heading">
...
<div class="panel-body">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-lg-10 text-center">
            <form method="post" class="f1" action="<?php echo base_url() ?>admin/update_team">
                <h3 class="m-t-0">Update Your Team</h3>
...
<br><br>
 ...
 <?php 
                             ...
                             $assigned_sub=$this->db->get_where('case_team_members',['subject_id'=>$subject['id']])->result_array();
                             
                            
                             
 ?>
                                <option value="<?php echo $subject['id'] ?>" selected><?php echo $subject['subject_name'] ?></option>
                         </select>
                       </div>
                    </div>
                                       ...
                                       <select   class="selectpicker form-control" multiple name="team_member[]">
                                         <option>Select Member</option>
                                          <?php foreach ($members1 as $member1): 
                                            $key = array_search($member1['id'], array_column($assigned_sub, 'team_member_id'));
                                            //echo '<script>alert('.$key.')</script>';
                                            if (array_key_exists($key, $assigned_sub)) {
                                                //echo '<script>alert('.$key.')</script>';
                                              ?>
                                            <option value="<?php echo $member1['id'] ?>" selected><?php echo $member1['employee_name'] ?></option>
                                          <?php 
                                            } else{
                                          ?>
