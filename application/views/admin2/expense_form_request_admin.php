                                           ...
                                           <tbody>
                                            ...
                                            ?>
                                              <tr>
                                                ...
                                                ?>
                                                <td>
                                                    <a href="<?php echo base_url() ?>admin/expense_form_approve_admin/<?php echo $list['id'] ?>/3"><button type="" class="btn btn-primary">Approve</button></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url() ?>admin/expense_form_approve_admin/<?php echo $list['id'] ?>/4"><button type="" class="btn btn-danger">Reject</button></a></td>
                                                <?php }else{ ?>
