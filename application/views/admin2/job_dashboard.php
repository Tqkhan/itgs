...
<!-- 	<td><span class="footable-toggle"></span><?php echo $case['sub_category'] ?></td>
 ...
 -->	<td><span class="footable-toggle"></span><?php echo $case['employee_name'] ?></td>
<?php if($case['approved_date']){ ?>
 <td><span class="footable-toggle"></span><?php echo date('d M Y h:i:s', strtotime($case['approved_date'])) ?></td>
<?php } else{ ?>
...
function fund_paid(id,amount,type) {
	...
	if (type=='Cash') {
         ...
         $('.type_payorder').attr('checked','ture');
