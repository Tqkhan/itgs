...
<input type="hidden" name="meetingID" value="<?php echo $meeting['meetingID'] ?>">
            ...
            <input type="hidden" name="clientID" value="<?php echo $_SESSION['login_id'] ?>">
                <input class="form-control" type="text" disabled="" value="<?php echo $_SESSION['login_name'] ?>" name="client_name" readonly="" id="example-text-input"  placeholder="">
            </div>
        ...
        <div class="form-group row">
          ...
          <label for="example-text-input" class="col-sm-4 col-form-label">Title<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" disabled="" name="title" id="example-text-input" placeholder="" value="<?php echo $meeting['title'] ?>"  required="">
            </div>
        ...
        <div class="form-group row">
           ...
           <div class="col-sm-8">
                <input class="form-control" type="time" disabled="" value="<?php echo $meeting['meeting_time'] ?>" name="meeting_time" id="example-text-input" placeholder="" required="">
            </div>
        ...
        <div class="form-group row">
          ...
          <label for="example-text-input" class="col-sm-4 col-form-label">Venue<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" disabled="" value="<?php echo $meeting['venue'] ?>" name="venue" id="example-text-input" placeholder="">
            </div>
        ...
        <div class="form-group row">
          ...
          <label for="example-text-input" class="col-sm-4 col-form-label">Notes<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" disabled="" value="<?php echo $meeting['notes'] ?>" name="notes" id="example-text-input" placeholder="">
            </div>
         ...
         <div class="form-group row">
          <label for="example-text-input" class="col-sm-4 col-form-label">Search Location<span class="required">*</span></label>
           <div class="col-sm-8">
                <input class="form-control" type="text" disabled="" value="<?php echo $meeting['tag_other_employee'] ?>" name="tag_other_employee" id="us3-address"  placeholder="">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
           ...
           <div class="col-sm-8">
                     ...
                     <div class="m-t-small">
                            ...
                            <div class="col-sm-6">
                                <label>Lat</label>
                                <input type="text" disabled="" class="form-control" name="lat"  value="<?php echo $meeting['lat'] ?>"  id="us3-lat" />
                            </div>

                            <div class="col-sm-6">
                                <label>Long</label>

                                <input type="text" disabled="" class="form-control" name="lon" value="<?php echo $meeting['lon'] ?>"  id="us3-lon"  />
                            </div>
                        </div>            </div>
        </div>
