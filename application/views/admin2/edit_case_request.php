...
<!-- main content -->
    <div class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
        <form method="post" class="show_form" action="<?php echo base_url() ?>admin/update_case" enctype="multipart/form-data">
                  ...
                  <div class="panel panel-default  panel-bd">
                    <div class="panel-heading" style="background-color: #7dbbdf;">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $count;?>">Subject <?php echo $s ?>
                          </a>
...
//echo $key;
              ...
              <tr>
                ...
                <td><input type="checkbox" name="scope_id[0][]" class="scope_value" value="<?php echo $activity['scope_id'] ?>" id="<?php echo $activity['scope_id'] ?>" <?php if (array_key_exists($key,$activities)) echo 'checked onclick="this.checked=!this.checked;"' ?>>
