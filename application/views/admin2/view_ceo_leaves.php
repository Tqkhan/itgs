                                ...
                                <form method="post" action="">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="start" value="<?php echo date('Y-m-d',strtotime($first)) ?>"> 
                                        </div>
                                        <div class="col-md-6">
                                            <label>Month</label>
                                            <input type="date" class="form-control" name="end" value="<?php echo date('Y-m-d',strtotime($last)) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                           ...
                                           <tbody>
                                            ...
                                            ?>
                                              <tr>
                                               ...
                                               <td><?php if($list['month_leaves']){echo $list['month_leaves'];}else{echo '0';} ?></td>
                                               <td><?php if($list['old_leaves']){echo $list['old_leaves'];}else{echo '0';} ?></td>
