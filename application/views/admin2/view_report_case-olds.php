                                ...
                                <div id="collapse1" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php } ?>
                                            <a class="" href=""><button type="submit" class="btn btn-primary pull-right download-btn" id="export">Downloads</button></a>
                                        </div>
                                        <div class="row download-table" id="docx" style="display: none;">
                                            <center><h4>Individual Background Screening Reports</h4></center>
                                            <?php foreach ($back as $ba) { ?>
                                ...
                                <div class="panel panel-default panel panel-bd">
                                    ...
                                    <div id="collapse2" class="panel-collapse collapse after-add-more">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <?php } ?>
                                            <a class="" href=""><button type="submit" class="btn btn-primary pull-right download-btn" id="v_report">Downloads</button></a>
                                        </div>
                                        <div class="row" id="v_report" style="display: none;">
                                            <center><h4>Vendor Report</h4></center>
                                            <?php foreach ($back as $ba) { ?>
                            ...
                            <div class="panel panel-default panel panel-bd">
                                ...
                                <div id="collapse7" class="panel-collapse collapse">
                                    <div class="panel-body ">
                                        ...
                                        <a class="" href=""><button type="submit" class="btn btn-primary pull-right download-btn" id="expor">Downloads</button></a>
                                        <?php } ?>
                                        <?php } ?>
                                    </div>
                                    <div class="panel-body download-table" id="docx" style="display: none;">
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Evidence : </td>
                                                        <td>
                                                            <a download href="<?php echo site_url() ?>/uploads/report/<?php echo $rep['attachment'] ?>">View Attechment</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
<script type = "text/javascript">
    $('.download-btn').click(function() {
        ...
        if (navigator.msSaveOrOpenBlob) navigator.msSaveOrOpenBlob(blob, 'Individual_Background Screening_Reports.doc');
        else link.click();
