...
<!-- main content -->
		<div class="content">
				...
				<form method="post" id="example-form" action="<?php echo base_url() ?>admin/client_creation_insert1" enctype="multipart/form-data">
...
$.toggleShowPassword({
    ...
    control: '#test2'
										...
										<div class="form-group row">
												...
												<div class="col-sm-9">
														<input class="form-control" type="text" name="website" pattern="www.+.com" value="" id="example-text-input" placeholder="" required="">
												</div>
										</div>
										...
										<div class="form-group row">
												...
												<div class="col-sm-3">
														<input class="form-control" type="text" name="reg_num" value="" id="example-text-input" placeholder="">
												</div>
												<label for="example-text-input" class="col-sm-2 col-form-label">Tax No<span class="required">*</span></label>
												<div class="col-sm-4">
														<input class="form-control" type="text" name="tax_num" value="" id="example-text-input" placeholder="">
												</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
												...
												<div class="col-sm-3">
														<input class="form-control" type="text" name="contract_start_date" value="" id="txtFromDate" placeholder="">
												</div>
												<label for="example-text-input" class="col-sm-2 col-form-label">Contract End Date<span class="required">*</span></label>
												<div class="col-sm-4">
														<input class="form-control" type="text" name="contract_end_date" value="" id="txtToDate" placeholder="">
												</div>
										</div>
										<script type="text/javascript">
        ...
        onSelect: function(selected) {
           $("#txtFromDate").datepicker("option","maxDate", selected)
										...
										<div class="form-group row">
												...
												<div class="col-sm-3">
														<input class="form-control" type="date" name="reg_date" min="<?php echo date('Y-m-d',strtotime("+0 days"))?>" value="" id="example-text-input" placeholder="">
												</div>
...
<thead>
		<tr>
		<th class="footable-sortable"><span class="checkbox checkbox-primary">
                    <input id="scopecheck59" type="checkbox" class="check-all">
                    <label for="scopecheck59"></label>
                </span> Check<span class="footable-sort-indicator"></span></th>
