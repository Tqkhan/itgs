...
<?php endif ?>
   <?php if ($_SESSION['role']=="Hr"): ?>
       <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>admin/employee_management" class="material-ripple"><i class="material-icons">home</i>  Employee Management</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">code</i>  Organogram<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Performance Review</a>
                        ...
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Memo/News</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Documents & Forms</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Recruitment<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <!-- usama code start -->
                        ...
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Compensation</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Insurance Services</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Leaves Management</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Travel Management</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Approvals</a>

                        </li>
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>  Disciplinary Actions<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <li><a href="#">Disciplinary Form</a></li>
                        ...
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>Testing Services<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <li><a href="<?php echo base_url() ?>admin/create_test">Create Test</a></li>
                        ...
                        <li>
                            <a href="#" class="material-ripple"><i class="material-icons">home</i>Operations<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <li><a href="<?php echo base_url() ?>admin/create_job_form">Create Job</a></li>
                                <li><a href="#">View Test</a></li>
                        ...
                        <li>
                         ...
                         <li>
                             ...
                             <ul class="nav nav-second-level">
                                ...
                                <li><a href="<?php echo base_url()?>admin/complaint_form">Complaint Form</a></li>
...
<ul class="nav" id="side-menu">
                        ...
                        <li><a href="<?php echo base_url() ?>admin/admin_dashboard1" class="fa fa-icon"><i class="fa fa-newspaper-o" style="color: #212eaf;"></i>Case Analysis</a></li>
...
<li>
                        ...
                        <!-- </li>-->
                         ...
                         <li>
                             <a href="#" class="material-ripple"><i class="material-icons">home</i>Training & Development<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <li><a href="#">Training Requisition</a></li>
                                </ul>
                                <ul class="nav nav-second-level">
                                <li><a href="#">Training Requisition</a></li>
                                </ul>
                                ...
                                <ul class="nav nav-second-level">
                                <li><a href="#">Training Library</a></li>
                                </ul>
                         </li>
...
<ul class="nav" id="side-menu">
                        ...
                        <li><a href="<?php echo base_url() ?>admin/employee_dashboard" class="fa fa-icon"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<?php echo base_url() ?>admin/job_dashboard" class="fa fa-icon"><i class="fa fa-file-text-o"></i> My Jobs</a></li>
<?php if ($_SESSION['role']== "Manager Finance" || $_SESSION['role']== "Internal Auditor") {?>
...
<hr>
 ...
 <li>
                         ...
                         <li><a href="#" class="fa fa-icon"><i class="fa fa-comments"></i>Discussion Board</a></li>
