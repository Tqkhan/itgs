...
foreach ($departments as $d) {
	if ($d['parent_id'] == 0) {
		$data[] = "[{v:'".$d['id']."', f:'<b>".$d['name'] . "</b><br/><a class=\"designation\" href=\"".base_url('admin/deparment_employee/'.$d['id'])."\">View detail</a>'}, '', '']";
	}
	else{
		$data[] = "[{v:'".$d['id']."', f:'<b>".$d['name'] . "</b><br/><a class=\"designation\" href=\"".base_url('admin/deparment_employee/'.$d['id'])."\">View detail</a>'}, '".$d['parent_id']."', '']";
	}
}
                ...
                <div class="panel panel-bd ">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <a href="<?php echo base_url('admin/departments') ?>"><button class="btn btn-primary pull-right">Create</button></a>
                        </div>
                    </div>
