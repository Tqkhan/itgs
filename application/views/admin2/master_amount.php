...
?>
  ...
  <td><span class="footable-toggle"></span><a href="#"><?php echo $a['client_name'] ?></a><span class="e" style="display: none;"><?php echo $a['client_name'] ?></span></td>

  <td><?php echo ($a['client_type'] == 'INT') ? 'International' : 'Local' ?></td>

  <td><?php echo ($a['client_type'] == 'INT') ? $a['amount'] : '' ?></td>

  <td class="fieldCell1"><?php echo ($a['client_type'] != 'INT') ? $a['amount'] : '' ?></td>
