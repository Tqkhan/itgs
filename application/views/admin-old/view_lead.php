...
<?php if ($key['status']=="process" || $key['status']=="approved" || $key['status']=="completed" ): ?>
                  <a href="<?php echo base_url() ?>admin/create_quote/<?php echo $key['leadID'] ?>"><img src="<?php echo base_url() ?>assets/vv-icon.png" title="View Lead" alt="Process for Approval" width="42" height="42"></a>
...
<?php endif ?>
         ...
         <?php if ($key['status']== "approved" || $key['status']== "completed"){ ?>
