        ...
        <section class="container">
            <div class="col-sm-12">
                ...
                <div class="col-sm-5 col-sm-offset-3">
                    <form method='post' action="<?php echo base_url() ?>web/login">
                        <?php 
                            if(isset($_GET['redirect'])){
                                echo '<input type="hidden" name="redirect" value="'.$_GET['redirect'].'">';
                            }
                        ?>
                        <p style="text-align: center;"><span class="heading-special3">sign in </span><br>
                        ...
                        <div class="login__control">
                            <button type='submit' class="btn btnmg1">sign in</button>
                        </div>
                        
                        <div class="login__control pull-right">
                            <a href="<?php echo base_url() ?>web/register">
                                <span style="color: #ffffff;">new user? </span><button type='button' class="btn">Create Account</button>
                            </a>
                        </div>
                    </form>
