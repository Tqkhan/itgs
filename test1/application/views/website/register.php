                ...
                <div class="col-sm-5 col-sm-offset-3">
                    <form  class="" method='post' action="<?php echo base_url() ?>web/create_user">
                        ...
                        <div class="field-wrap1">
                          <input type='text' placeholder='Name' name='user_name' class="login__input">
                        <input type='text' placeholder='Contact Number' name='phone_number' class="login__input">
                        <input type='text' placeholder='CNIC' name='user_cnic' class="login__input">
