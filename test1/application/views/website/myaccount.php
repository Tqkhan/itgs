        ...
        <section class="container">
            <div class="col-sm-12">
                ...
                <div class="col-sm-5 col-sm-offset-3">
                    <form  class="" method='post' action="<?php echo base_url() ?>web/update_account">
                        <p style="text-align: center;"><span class="heading-special3">Update Profile </span><br>
                        ...
                        <div class="field-wrap1">
                          <input type='text' placeholder='Name' name='user_name' value="<?php echo $_SESSION['user_name'] ?>" class="login__input">
                        <input type='text' placeholder='Phone Number' value="<?php echo $_SESSION['phone_number'] ?>" name='phone_number' class="login__input">
                        <input type='email' placeholder='Email' name='email' value="<?php echo $_SESSION['email'] ?>" class="login__input">
                        <input type='number' placeholder='phone_number' name='phone_number' value="<?php echo $_SESSION['phone_number'] ?>" class="login__input">
                        <input type='text' placeholder='Password' value="<?php echo $_SESSION['password'] ?>" name='password' class="login__input">
