...
<?php if (!empty($_SESSION['adminID'])){ ?>
 <!--
                   ...
                   <form id='contact-info' method='post' action="<?php echo base_url() ?>web/update_user_data" novalidate="" class="form contact-info">
                          <div class="col-lg-4">
                            <div class="contact-info__field contact-info__field-mail">
                            <input type='email' name='user_name' placeholder='Your email' class="form__mail" value="<?php echo $_SESSION['email'];?>">
                        </div>
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="order">
                    ...
                    <a href="<?php echo base_url() ?>web/confirm" class="btn btn-md btn--warning btn--wide"></a>
                </div>
